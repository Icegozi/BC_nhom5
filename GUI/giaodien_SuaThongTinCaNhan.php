    ...
    <main>
        ...
        <section class="edit-profile" id="">
            <div class="container">
                <div class="row">
                    <div class="col-md-6">
                        <img src="images/medium-shot-young-people-recording-podcast.jpg" alt="Hình ảnh"
                            class="img-fluid"><br>
                        <h4 class="title">Hà Xuân Phúc</h4>
                        <textarea name="content" id="content"
                            readonly>Hiện tại là quá khứ của tương lai, hôm nay là bức hình của khoảnh khắc</textarea>
                    </div>
                    <div class="col-md-6">
